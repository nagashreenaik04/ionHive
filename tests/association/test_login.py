...
class TestLogin:
    ...
    url = "http://172.235.29.67:7777/associationadmin/"

    logger = LogGen.loggen()
    email = "outdidassociation@gmail.com"
    password = "1234"
    trim_email = "outdidassociation@gmail.com         "
    ...
    test_data = [
        ...
        ("outdidclient@gmail.com", "1234", "Error: Invalid credentials or user is deactivated"), #Error: Unauthorized role
