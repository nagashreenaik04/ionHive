...
class TestLogin:
    ...
    url = "http://172.235.29.67:7777/reselleradmin/"

    logger = LogGen.loggen()
    email = "outdidreselleradmin@gmail.com"
    password = "1234"
    trim_email = "outdidreselleradmin@gmail.com         "

    #invalid login
    test_data = [
        ("aoutdidsuperadmins@gmail.com", "1234", "Error: Invalid credentials or user is deactivated"),
        ("outdidreselleradmin@gmail.com", "1235", "Error: Invalid credentials or user is deactivated"), #Error: Invalid password
        ("outdidassociation@gmail.com", "1234", "Error: Invalid credentials or user is deactivated"), #Error: Unauthorized role
        ("aoutdidsuperadmins@gmail.com", "1235", "Error: Invalid credentials or user is deactivated"),
    ]
    ...
    test_password_error = [
        ...
        ("1235", "Error: Invalid credentials or user is deactivated") #Error: Invalid password
    ]
